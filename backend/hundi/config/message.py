...
THREAD_RUN_EXCEPTION = "Thread run expection: {}"
THREAD_LOOP_EXCEPTION = "Thread loop expection: {}"
THREAD_STATUS_EXCEPTION = "Thread status expection: {}"
ACTION_RUN_EXCEPTION = "Action run expcetion: {}"
ACTION_LOOP_EXCEPTION = "Action loop expcetion: {}"
